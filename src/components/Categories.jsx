...
export const Categories = () => {
  ...
  return (
    ...
    {
        state.category.map((item) =><div onClick={()=>dispatch({type: "SELECTED_TYPE", payload: item.categoryName})}>
          <div key={item._id} onClick={()=>dispatch({type: "EACH_CATEGORY" , payload: item.categoryName})}>
